 ...
 * @author ezioc
 */
public class Menu_hites extends javax.swing.JFrame {
    ...
    public Menu_hites(Menu_principal menu) {
        this.menu = menu;
        initComponents();
        this.setLocationRelativeTo(null);
        String montos [] = {"Montos"};
        dtm.setColumnIdentifiers(montos);
        tabla_hites.setModel(dtm);
        this.txt_monto.setText("0");
        
        Cont_hites cf = new Cont_hites(this);
    ...
    private void initComponents() {
        ...
        tabla_hites = new javax.swing.JTable();
        ...
        tabla_hites.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabla_hites);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        jLabel1.setText("Hites");
    ...
    private javax.swing.JTable tabla_hites;
