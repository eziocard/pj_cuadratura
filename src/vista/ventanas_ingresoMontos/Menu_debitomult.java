 ...
 * @author ezioc
 */
public class Menu_debitomult extends javax.swing.JFrame {
    ...
    public Menu_debitomult(Menu_principal menu) {
        this.menu = menu;
        initComponents();
        this.setLocationRelativeTo(null);
        String montos [] = {"Montos"};
        dtm.setColumnIdentifiers(montos);
        tabla_debitomult.setModel(dtm);
        this.txt_monto.setText("0");
        
        Cont_debitomult cf = new Cont_debitomult(this);
    ...
    private void initComponents() {
        ...
        tabla_debitomult = new javax.swing.JTable();
        ...
        tabla_debitomult.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabla_debitomult);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        jLabel1.setText("Debito-Multicaja");
    ...
    private javax.swing.JTable tabla_debitomult;
    ...
    public JTable getTabla_debitomult() {
        return tabla_debitomult;
    }
