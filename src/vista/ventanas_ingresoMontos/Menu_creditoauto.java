...
import controlador.Cont_creditoauto;
 ...
 * @author ezioc
 */
public class Menu_creditoauto extends javax.swing.JFrame {
    ...
    public Menu_creditoauto(Menu_principal menu) {
        this.menu = menu;
        initComponents();
        this.setLocationRelativeTo(null);
        String montos [] = {"Montos"};
        dtm.setColumnIdentifiers(montos);
        tabla_creditoauto.setModel(dtm);
        this.txt_monto.setText("0");
        
        Cont_creditoauto cf = new Cont_creditoauto(this);
    ...
    private void initComponents() {
        ...
        tabla_creditoauto = new javax.swing.JTable();
        ...
        tabla_creditoauto.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabla_creditoauto);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        jLabel1.setText("Credito-AutoServicio");
    ...
    private javax.swing.JTable tabla_creditoauto;
    ...
    public JTable getTabla_creditoauto() {
        return tabla_creditoauto;
    }
