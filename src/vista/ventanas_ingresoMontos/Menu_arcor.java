 ...
 * @author ezioc
 */
public class Menu_arcor extends javax.swing.JFrame {
    ...
    public Menu_arcor(Menu_principal menu) {
        this.menu = menu;
        initComponents();
        this.setLocationRelativeTo(null);
        String montos [] = {"Montos"};
        dtm.setColumnIdentifiers(montos);
        tabla_arcor.setModel(dtm);
        this.txt_monto.setText("0");
        
        Cont_arcor cf = new Cont_arcor(this);
    ...
    private void initComponents() {
        ...
        tabla_arcor = new javax.swing.JTable();
        ...
        tabla_arcor.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabla_arcor);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        jLabel1.setText("Arcor");
    ...
    private javax.swing.JTable tabla_arcor;
