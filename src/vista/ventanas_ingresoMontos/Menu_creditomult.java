...
import controlador.Cont_creditomult;
import controlador.Cont_debitoauto;
import controlador.Cont_debitomult;
 ...
 * @author ezioc
 */
public class Menu_creditomult extends javax.swing.JFrame {
    ...
    public Menu_creditomult(Menu_principal menu) {
        this.menu = menu;
        initComponents();
        this.setLocationRelativeTo(null);
        String montos [] = {"Montos"};
        dtm.setColumnIdentifiers(montos);
        tabla_creditomult.setModel(dtm);
        this.txt_monto.setText("0");
        
        Cont_creditomult cf = new Cont_creditomult(this);
    ...
    private void initComponents() {
        ...
        tabla_creditomult = new javax.swing.JTable();
        ...
        tabla_creditomult.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabla_creditomult);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        jLabel1.setText("Credito-Multicaja");
    ...
    private javax.swing.JTable tabla_creditomult;
    ...
    public JTable getTabla_creditomult() {
        return tabla_creditomult;
    }
