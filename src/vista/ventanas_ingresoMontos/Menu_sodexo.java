...
import controlador.Cont_sodexo;
 ...
 * @author ezioc
 */
public class Menu_sodexo extends javax.swing.JFrame {
    ...
    public Menu_sodexo(Menu_principal menu) {
        this.menu = menu;
        initComponents();
        this.setLocationRelativeTo(null);
        String montos [] = {"Montos"};
        dtm.setColumnIdentifiers(montos);
        tabla_sodexo.setModel(dtm);
        this.txt_monto.setText("0");
        
        Cont_sodexo cf = new Cont_sodexo(this);
    ...
    private void initComponents() {
        ...
        tabla_sodexo = new javax.swing.JTable();
        ...
        tabla_sodexo.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabla_sodexo);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        jLabel1.setText("Sodexo");
    ...
    private javax.swing.JTable tabla_sodexo;
