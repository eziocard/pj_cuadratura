 ...
 * @author ezioc
 */
public class Menu_debitoauto extends javax.swing.JFrame {
    ...
    public Menu_debitoauto(Menu_principal menu) {
        this.menu = menu;
        initComponents();
        this.setLocationRelativeTo(null);
        String montos [] = {"Montos"};
        dtm.setColumnIdentifiers(montos);
        tabla_debitoauto.setModel(dtm);
        this.txt_monto.setText("0");
        
        Cont_debitoauto cf = new Cont_debitoauto(this);
    ...
    private void initComponents() {
        ...
        tabla_debitoauto = new javax.swing.JTable();
        ...
        tabla_debitoauto.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabla_debitoauto);

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 48)); // NOI18N
        jLabel1.setText("Debito-AutoServicio");
    ...
    private javax.swing.JTable tabla_debitoauto;
    ...
    public JTable getTabla_debitoauto() {
        return tabla_debitoauto;
    }
